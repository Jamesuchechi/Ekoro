  ...
  return (
    <div className="p-6 max-w-4xl mx-auto min-h-[70vh] flex flex-col items-center justify-center space-y-6 text-center animate-page">
      <div className="relative">
        <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-ekoro-green to-teal-500 blur opacity-30 animate-pulse" />
        <div className="relative w-24 h-24 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-4xl">
          <Download className="w-10 h-10 text-ekoro-green" />
        </div>
      </div>
      ...
      <div className="space-y-2 max-w-md">
        ...
        <p className="text-sm text-white/50 leading-relaxed">
          Soon you will be able to download your purchased and offline tracks directly to your local library. We are building a secure offline license manager for this feature.
        </p>
      </div>
